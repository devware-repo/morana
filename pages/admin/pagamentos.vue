  ...
  <div v-if="produtos.itens" id="admin-cover" class="position-relative">
    ...
    <div class="produtos-tela position-relative">
      <div class="container-fluid">
        ...
        <div
          class="d-none d-md-flex row product-parent mt-4"
          data-product-id="1"
        >
          <div class="col">
          ...
          <div class="col">
            ...
            <p class="admin-produto-description" data-modalInputName="nome">
              Colar Coração Dourado
            </p>
            <p
              class="admin-produto-description d-none"
              data-modalInputName="descricao"
            >
              Colar em forma de Coração em cor dourado feito em tudo de bom
            </p>
          </div>
          <div class="col">
          ...
          <div class="col">
            ...
            <p class="admin-produto-description" data-modalInputName="cor">
              Dourado
            </p>
          </div>
          <div class="col">
          ...
          <div class="col">
            <h1 class="admin-type mb-3 ">Pedido em:</h1>
            <p class="admin-produto-description">27/11/2019</p>
          </div>
        ...
        <!-- Fim Listagem dos Produtos Desktop-->
        ...
        <div class="d-flex d-md-none row no-gutters mt-4" data-product-id="1">
          ...
          <div class="col-3">
            <p class="admin-produto-description">Nome: Colar Coração Dourado</p>
        ...
        <!-- Fim Listagem dos Produtos Mobile-->
      </div>
    </div>
  </div>
</template>
